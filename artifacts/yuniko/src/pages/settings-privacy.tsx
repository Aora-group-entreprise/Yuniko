...
export default function PrivacySettings(){
 ...
 const patch=async(values:Partial<Settings>)=>{if(!s)return; const next={...s,...values}; setS(next); try{await apiJson("/settings",{method:"PATCH",body:JSON.stringify(values)})}catch(e){setS(s);setError(e instanceof Error?e.message:"Failed to save")}};
